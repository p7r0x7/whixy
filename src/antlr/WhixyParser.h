...
public:
  ...
  enum {
    RuleSrcFile = 0, RuleStatement = 1, RuleValStmt = 2, RuleExpression = 3, 
    RuleBlockExpr = 4, RuleValsExpr = 5, RuleProcedureExpr = 6, RuleFunctionExpr = 7, 
    RuleTypeExpr = 8, RuleTupleExpr = 9, RuleCallExpr = 10, RuleEndOfExp = 11, 
    RuleEndOfStmt = 12
  };
